        ...
        if(($arrayu['userEmail'] != $_POST['email'])){
            ...
            if(($arrayu['userPassword']) != ($_POST['password'])){
                ...
                if($_SESSION['usertype']=='a'){
                    ...
                    echo "<p>You have successfully logged in as a Hit Ad ".$_SESSION['usertype'];
                    echo "<p>Continue to the home page <a href='admin.php'>Hit Ad</a>";
                }
                else{
                    $_SESSION['usertype']='Customer';
                    echo "<p>You have successfully logged in as a Hit Ad ".$_SESSION['usertype'];
                    echo "<p>Continue shopping for <a href='index.php'>Hit Ad</a>";
                    echo "<p>View your <a href='basket.php'>Wish List</a>";
                }
